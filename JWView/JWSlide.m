...
//    [conView addSubview:img];
    ...
    UIImageView *imgv1 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"ic_sleep_night_slide"]];
    imgv1.frame = CGRectMake(0, 0, 19, 51);
    [conView addSubview:imgv1];
    UIImageView *imgv2 = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"ic_sleep_morning_slide"]];
...
- (void)drawRect:(CGRect)rect {
    ...
    //设置颜色
    CGContextSetStrokeColorWithColor(context, [UIColor redColor].CGColor);   //设置颜色
    //开始绘制
